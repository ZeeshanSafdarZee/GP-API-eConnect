...
{
    public partial class SOPHistHeader
    {
        [Key]
        ...
        //public ICollection<SOPTracking> SOPTracking { get; set; }
        //       = new List<SOPTracking>();

        public ICollection<SOPHistLine> SOPHistLines { get; set; }
               = new List<SOPHistLine>();
