...
{
    public partial class SOPWorkHeader
    {
        ...
        public ICollection<SOPWorkLine> SOPWorkLines { get; set; }
               = new List<SOPWorkLine>();

        public ICollection<SOPTracking> SOPTrackingNumbers { get; set; }
               = new List<SOPTracking>();
